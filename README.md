# DKNightVersion
DKNightVersion is a light weight framework. It's built through `objc/runtime` library, providing a neat approach  adding night version to your iOS app. It is well designed and a great many of code is generated by Ruby script.

The most delightful feature the framework providing is that it adds one more property to frequently-used UIKit components --- `nightColor`. It is easy and a great joy to use DKNightVersion integrating night mode to your iOS App.
