...
The most delightful feature the framework providing is that it adds one more property to frequently-used UIKit components --- `nightColor`. It is easy and a great joy to use DKNightVersion to integrate night mode in your iOS App.
